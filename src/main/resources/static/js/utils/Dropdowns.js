$(document).ready(function () {
    ...
    // Initialize Select2
    $('#gradeDropdown, #subjectDropdown').select2({
    ...
    // Subjects (directly by Grade, skipping Semester)
    $('#gradeDropdown').on('change', function () {
        ...
        // Updated endpoint: directly fetch subjects by grade
        fetchData('/api/subjects/by-grade', {gradeId: gradeId}).done(function (subjects) {
